      ...
      <div className="px-8 mx-auto max-w-7xl lg:px-12 xl:px-16">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex items-center w-full lg:w-1/2 lg:pr-10">
            <div className="relative max-w-lg mx-auto  text-center text-stone-700 border-stone-200 lg:text-left">
              <h1 className="m-0 text-3xl font-extrabold leading-tight text-left text-orange-600 border-solid sm:text-4xl md:text-6xl">
                Discover Your Path To Success
              </h1>
              <p className="pr-5 mx-0 my-4 text-base text-left text-stone-500 xl:leading-9 lg:my-8 xl:text-xl">
                Unlock Your Potential as a Developer with our job search app designed specifically
                for junior and self-taught developers.
              </p>
              <div className="relative flex items-start justify-start block w-full max-w-md text-center lg:mx-0">
                {/*<a*/}
                {/*  href="#_"*/}
                {/*  className="flex items-center justify-center px-8 font-medium text-white bg-orange-500 rounded-full h-14"*/}
                {/*  data-primary="orange-500"*/}
                {/*  data-rounded="rounded-full"*/}
                {/*>*/}
                {/*  Start Your Journey*/}
                {/*</a>*/}
                <Button color="orange">Start Your Journey</Button>
              </div>
              <div className="mt-10 leading-6 text-left border-solid">
                <p className="m-0  text-sm font-bold tracking-wider text-stone-400 uppercase lg:text-xs">
                  Recently Featured On
                </p>
                <div className="flex mt-5 space-x-4">
                  <svg
                    className="w-auto h-8 text-stone-300 fill-current"
          ...
          <div className="relative w-full mt-20 lg:w-1/2 lg:mt-0">
            <div className="relative z-20 grid w-full grid-cols-4 gap-5 mt-4 transform -rotate-6">
              ...
              >
                <img
                  src="https://cdn.devdojo.com/images/january2021/image1.png"
              ...
              >
                <img
                  src="https://cdn.devdojo.com/images/january2021/image2.png"
                  className="w-full h-auto"
                />
              </div>
              <div
              ...
              >
                <img
                  src="https://cdn.devdojo.com/images/january2021/image3.png"
                  className="w-full h-auto"
                />
              </div>
              <div
              ...
              >
                <img
                  src="https://cdn.devdojo.com/images/january2021/image4.png"
                  className="w-full h-auto"
                />
              </div>
              <div
              ...
              >
                <img
                  src="https://cdn.devdojo.com/images/january2021/image5.png"
                  className="w-full h-auto"
                />
              </div>
              <div
              ...
              >
                <img
                  src="https://cdn.devdojo.com/images/january2021/image6.png"
                  className="w-full h-auto"
                />
              </div>
            </div>
            <div className="absolute top-0 right-0 z-10 w-full h-full mt-4 -mr-5 transform scale-125 rotate-45">
              <svg
                className="absolute top-0 w-full h-full transform opacity-50 fill-current lg:scale-x-150 text-orange-100/50"
                data-primary="orange-600"
                viewBox="0 0 200 200"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
