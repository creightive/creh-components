...
const FeaturesSection = () => {
  return (
    <section
      ...
      className="box-border flex flex-col items-center px-8 py-20 mx-auto leading-6 border-solid max-w-7xl xl:px-16 md:items-stretch md:justify-center md:py-24 tails-selected-element"
    >
      <div className="relative pb-10">
        ...
        <h2 className="w-full m-0  text-4xl font-black leading-loose tracking-wide text-center text-[--sand-12] border-0 border-stone-200 sm:text-5xl">
          Amazing Features
        </h2>
      ...
      <div className="z-10 grid gap-5 md:grid-cols-6 lg:grid-cols-9">
        {/* Feature 1 */}
        <div
          className="col-span-3  text-[--sand-12] bg-[--sand-2] rounded-3xl"
        ...
        >
          <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
            <div
              className="flex-shrink-0 p-3  text-[--sand-12] border border-[--sand-6] rounded-full"
              data-rounded="rounded-full"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="leading-6 text-center text-[--sand-12] align-middle stroke-current w-7 h-7"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
                stroke="#2c3e50"
                fill="none"
            ...
            <div className="mt-4  text-left text-[--sand-12] border-0 border-[--sand-6] sm:mt-2 sm:ml-4">
        ...
        {/* Feature 6 */}
        <div
          className="col-span-3  text-[--sand-12] border-0 bg-[--sand-2] rounded-3xl"
          data-rounded="rounded-3xl"
          data-rounded-max="rounded-full"
        >
          <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
