      ...
      <div className="px-8 mx-auto max-w-7xl lg:px-12 xl:px-16">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex items-center w-full lg:w-1/2 lg:pr-10">
            <div className="relative max-w-lg mx-auto  text-center text-stone-700 lg:text-left">
              <h1 className="m-0 text-3xl font-extrabold leading-tight text-left text-[--orange-9] border-solid sm:text-4xl md:text-6xl">
